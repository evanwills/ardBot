...
// 1.
// 2. for each child,
//    a. get radiusPointX & radiusPointY
//    b. rotate radiusPointX & radiusPointY around current
//       orginX & orginY
//    c. send new radiusPointX & radiusPointY back to child
...
/**
 * @function depthOK() is used to varify that the stack of circles is
 *         OK. By OK, I mean that the last circle is a singleCircle
 *         object and that no MultiCircle objects were added after it.
 *
 * This method should be called after all the circleManager objects
 * have been initialised.
 *
 * NOTE: Because of the way MultiCircle is setup, it should be OK to
 *       use a stack even if the output of depthOK() is FALSE.
 * @returns boolean
 */
...
/**
 * @function setChildCircle() adds another circleManager
...
/**
 * @function setRadiusPointXY() sets the radius point at a
...
/**
 * @function getCircleShape() returns the circleShape object
...
/**
 * @function getDepth() returns the level in the stack that the
 *           circle is at
 *           e.g. if there are 5 circles in the stack and this one
 *                was added fourth, it's depth would be 1
 */
...
/**
 * @function getRadiusPointX() returns the this.radiusPointX
...
/**
 * @function getRadiusPointY() like getRadiusPointX() but for
 *               the Y value
 */
...
function SingleCircle (circle) {
  ...
  if (typeof circle !== 'CircleShape') {
    throw Error('SingleCircle expects only parameter to be a CircleShape object. ' + typeof circle + ' given')
  }
  this.circle = circle
}
...
/**
 * @function move() rotates its own radius points
 */
...
MultiCircle.prototype.setChildCircle = function (childCircle) {
  'use strict'
  if (childCircle instanceof SingleCircle) { } else {
    throw Error('MultiCircle.setChildCircle() expects only parameter "childCircle" to be either a SingleCircle or MultiCircle object. ' + childCircle.prototype + ' given.')
  }
...
/**
 * @function move() rotates its own radius points as
...
/**
 * @function depthOK() checks whether the hierarchy of nested
 *           circles is correct
 */
...
/**
 * @function fixDepth() makes sure the hierarchy of nested
 *           circles is correct
 */
