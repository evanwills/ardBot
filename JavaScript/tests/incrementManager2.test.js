...
var incCum_IncDecay = new IncrementDecoratorCumulative(
	new IncrementDecoratorDecay(
		fixedInc,
		0.9908
	)
);
report('IncrementDecoratorCumulative(IncrementDecoratorDecay(' + fixedInc.getStep() + ', 0.9908))', incCum_IncDecay);
...
var incDecay_incCum = new IncrementDecoratorDecay(
	new IncrementDecoratorCumulative(
		fixedInc
	),
	0.9908
);
report('IncrementDecoratorDecay(IncrementDecoratorCumulative(' + fixedInc.getStep() + '), 0.9908)', incDecay_incCum);

max = new IncrementManager(360);
var incReset_incDecay = new IncrementDecoratorReset(
	new IncrementDecoratorDecay(
		fixedInc,
		0.9908
	),
...
report('IncrementDecoratorReset(IncrementDecoratorDecay(' + fixedInc.getStep() + ', 0.9908), ' + min.getStep() + ', ' + max.getStep() + ')', incReset_incDecay);
var incDecay_incReset = new IncrementDecoratorDecay(
...
report('IncrementDecoratorDecay(IncrementDecoratorReset(' + fixedInc.getStep() + ', 0.9908), ' + min.getStep() + ', ' + max.getStep() + ')', incDecay_incReset);

var incOscil_incDecay = new IncrementDecoratorOscillate(
	new IncrementDecoratorDecay(
		fixedInc,
		0.9908
	),
...
report('IncrementDecoratorOscillate(IncrementDecoratorDecay(' + fixedInc.getStep() + ', 0.9908), ' + min.getStep() + ', ' + max.getStep() + ')', incOscil_incDecay);


var incDecay_incOscil = new IncrementDecoratorDecay(
...
report('IncrementDecoratorDecay(IncrementDecoratorOscillate(' + fixedInc.getStep() + ', 0.9908), ' + min.getStep() + ', ' + max.getStep() + ')', incDecay_incOscil);


var incCum_incOscil_incDecay = new IncrementDecoratorCumulative(
	new IncrementDecoratorOscillate(
		new IncrementDecoratorDecay(
			fixedInc,
			0.9908
...
report('IncrementDecoratorCumulative(IncrementDecoratorOscillate(IncrementDecoratorDecay(' + fixedInc.getStep() + ', 0.9908), ' + min.getStep() + ', ' + max.getStep() + '))', incCum_incOscil_incDecay);


var incCum_incDecay_incOscil = new IncrementDecoratorCumulative(
	new IncrementDecoratorDecay(
		new IncrementDecoratorOscillate(
			fixedInc,
			min,
...
report('IncrementDecoratorCumulative(IncrementDecoratorDecay(IncrementDecoratorOscillate(' + fixedInc.getStep() + ', 0.9908), ' + min.getStep() + ', ' + max.getStep() + '))', incCum_incDecay_incOscil);
